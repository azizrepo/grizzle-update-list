...
<h1>Product Update page</h1>
	<div id="container">
		<form action="update" method="post">
			<table border="0" style="float: left">
				...
				<tr>
					<td><input type="text" id="productName" name="productId" value="${product.productId }" readonly="readonly"
						placeholder="product" required="required"></td>
				</tr>
				...
				<tr>
					<td><input type="text" id="productName" name="productPrice" value="${product.productPrice }"
						placeholder="Productprice" required="required"></td>
				</tr>
				<tr>
					<td><select name="productCategory.categoryId" id="category" required="required">
				...
				<tr>
					<td><select name="productBrand.brandId" id="brand" required="required">
							<option value="">Brand
							<option value="101">mi
	...
	<div id="footer">cognizant &copy; Congizant Associates</div>
